...
{
    // 1. 角度转编码器值 (目标值) - 使用标准转化函数
    
    // Yaw: GM6020 直驱 (Ratio 1.0) + 1429 偏移量(机械零点偏移)
    int32_t yaw_target_cnt = dji_angle_to_encoder(yaw_deg, RATIO_GM6020) + 1429;
    
    // Pitch: M2006 (Ratio 36.0)
    int32_t pitch_target_cnt = dji_angle_to_encoder(pitch_deg, RATIO_M2006);
