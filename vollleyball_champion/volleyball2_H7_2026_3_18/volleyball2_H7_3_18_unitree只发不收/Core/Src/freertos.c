...
void StartTask02(void *argument)
{
  ...
  // --- 2. ���������������? ---
  const float CUSHION_READY_DEG = 47.0f;   // ���������ʼ�Ƕȣ���?
  const float CUSHION_ACTION_DEG = 114.0f;// ������������Ƕȣ���?
  const float SERVE_READY_RAD    = 30.0f; // ���������ʼ�Ƕȣ���?
...
void StartTask05(void *argument)
{
  ...
  // ���������������?
  #define CUSHION_READY_DEG   47.0f    // ��ʼ�Ƕ�
  #define CUSHION_SPEED      2.06f     // ��ʼ�ٶ�
  #define ACTION_HOLD_MS      800      // ��������ʱ�䣨ms��
  const float CUSHION_ACTION_DEG = 114.0f; // �����Ƕ�
