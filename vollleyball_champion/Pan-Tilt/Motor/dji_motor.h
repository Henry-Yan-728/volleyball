...
/* 定义电机索引，方便应用层调用 */
#define GIMBAL_MOTOR_YAW_ID    0 // 假设Yaw轴使用索引0
#define GIMBAL_MOTOR_PITCH_ID  1 // 假设Pitch轴使用索引1

/**
 * @brief 电机 ID 枚举
 */
typedef enum{
// M3508 / M2006 / GM6020(拨码1-4)
    CAN_ID_M1 = 0x201,
    CAN_ID_M2 = 0x202,
    CAN_ID_M3 = 0x203,
    CAN_ID_M4 = 0x204,
    
    // GM6020(拨码5-8) 或 M3508/2006(ID 5-8)
    CAN_ID_M5 = 0x205, // 建议6020设为ID 5 (Rx:0x205) 以便与2006区分
    CAN_ID_M6 = 0x206,
    CAN_ID_M7 = 0x207,
    CAN_ID_M8 = 0x208,
} can_msg_id_e;
