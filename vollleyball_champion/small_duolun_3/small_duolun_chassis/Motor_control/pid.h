...
extern ElemType iy;
extern ElemType dy;
extern pid_incremental_struct chassis_ang;
extern motor_pid_parameter motor_6020_pid_g[7];/*电机pid参数*/
extern motor_pid_parameter motor_3508_pid_g[8];
extern motor_pid_parameter move_pid_g[2];/*排球车移动pid参数*/
