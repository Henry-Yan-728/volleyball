...
int bang_flag=1;
  ...
  for(;;)
  {
      ...
      {
          /* --- �ֶ�ģʽ��ң����ֱ�ӿ��Ƶ��� --- */
          target_vx = local_rc.vx / 100.0f;  // X���ٶȣ���һ����-1~1��
          target_vy = local_rc.vy / 100.0f;  // Y���ٶȣ���һ����-1~1��
      ...
      switch (serve_state) {
          ...
          case ACTION_STEP_2:
											if(bang_flag==0){
					Chassis_Update(0,80.0f,0);
           if (current_tick - serve_start_tick > 490) {
              Mechanism_Serve_SetAngle(SERVE_ACTION_RAD); 
					...
					case ACTION_STEP_3:
						if(bang_flag==0){
							if(current_tick-serve_start_tick>350)
							{
					...
					// �׶�2�����������λ�����٣�?+ �����������?
					if(current_tick-serve_start_tick>1200&&current_tick-serve_start_tick<1900)
					{
              Mechanism_Cushion_SetAngle(CUSHION_READY_DEG, 0.3f);
					}
              // ����ʱ800ms��λ������״̬
              if (current_tick - serve_start_tick > 2500) {
