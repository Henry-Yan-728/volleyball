...
int main(void)
{
  ...
  HAL_TIM_PWM_Stop(&htim5, TIM_CHANNEL_1);
	...
	HAL_UARTEx_ReceiveToIdle_DMA(&huart3, Rx_data3, 500);//��������1IDLE�ж�+DMA����
	__HAL_DMA_DISABLE_IT (&hdma_usart3_rx ,DMA_IT_HT );//�رս��չ����ж�
	HAL_UARTEx_ReceiveToIdle_DMA(&huart1, Rx_data1, 500);//��������2IDLE�ж�+DMA����
	__HAL_DMA_DISABLE_IT (&hdma_usart1_rx ,DMA_IT_HT );//�رս��չ����ж�
////	OPEN_adjust();//����У��
////	ADC_adjust();
	test=1;//����У��
	send_flag=1;
	V_Flag_1=0;
	HAL_TIM_Base_Start_IT (&htim7);//���жϿ�����ʱ��7
	HAL_TIM_Base_Start_IT (&htim2);//���жϿ�����ʱ��2
	HAL_TIM_Base_Start_IT (&htim4);//���жϿ�����ʱ��4
	time[0]=HAL_GetTick();
...
//			uint16_t sum = code_zip[1] + code_zip[2] + code_zip[3] + code_zip[4] + code_zip[5] + code_zip[6] + (code_zip[7] & 0x80); // �������λ��ťֵ
//			code_zip[7] |= (sum & 0x7F);
