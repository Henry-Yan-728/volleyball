...
//////			Printf(&huart4,"check.j0.val=%d\xff\xff\xff",x_stick);//准确x显示
//////			Printf(&huart4,"check.j1.val=%d\xff\xff\xff",y_stick);//准确y显示
//////			Printf(&huart4,"check.j2.val=%d\xff\xff\xff",z_stick);//准确z显示
//////			x_stick=X_Value1-660;
//////			y_stick=Y_Value1-660;
//////			z_stick=C_Value1-660;
//////			Printf(&huart4,"check.n0.val=%d\xff\xff\xff",x_stick);//准确x显示
//////			Printf(&huart4,"check.n1.val=%d\xff\xff\xff",y_stick);//准确y显示
//////			Printf(&huart4,"check.n2.val=%d\xff\xff\xff",z_stick);//准确z显示
			}
...
{
	test = 1;
	HAL_ADC_Start_DMA(&hadc1, ADC_Value, 80);//ADC_DMA 启动
	
}
void OPEN_adjust(void)//开机校验
{
	ADC_adjust();
//////	Printf(&huart1,"setting.t0.txt=\"%.2f\"\xff\xff\xff",Bat_Value);//准确电压显示
//////	Printf(&huart1,"check.j0.val=%d\xff\xff\xff",50);//准确电压显示
//////	Printf(&huart1,"check.j1.val=%d\xff\xff\xff",50);//准确电压显示
//////	Printf(&huart1,"check.j2.val=%d\xff\xff\xff",50);//准确电压显示
//////			if(Bat_Value>8.0&&Bat_Value<8.4)//五格
//////			{
//////			Printf(&huart1,"main.p1.pic=14\xff\xff\xff");
//////			}
//////			else if(Bat_Value>7.8&&Bat_Value<8.0)//四格
//////			{
//////			Printf(&huart1,"main.p1.pic=13\xff\xff\xff");
//////			}
//////			else if(Bat_Value>7.6&&Bat_Value<7.8)//三格
//////			{
//////			Printf(&huart1,"main.p1.pic=12\xff\xff\xff");
//////			}
//////			else if(Bat_Value>7.5&&Bat_Value<7.6)//两格
//////			{
//////			Printf(&huart1,"main.p1.pic=11\xff\xff\xff");
//////			}
//////			else if(Bat_Value>7.3&&Bat_Value<7.5)//一格
//////			{
//////			Printf(&huart1,"main.p1.pic=10\xff\xff\xff");
//////			}
//////			else if(Bat_Value>7&&Bat_Value<7.3)//零格
//////			{
...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PA6     ------> ADC1_IN6
    */
    GPIO_InitStruct.Pin = GPIO_PIN_1|X_Pin|Y_Pin|C_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA6     ------> ADC1_IN6
    */
    HAL_GPIO_DeInit(GPIOA, GPIO_PIN_1|X_Pin|Y_Pin|C_Pin);
