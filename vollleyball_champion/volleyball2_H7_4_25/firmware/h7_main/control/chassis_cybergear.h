...
#define CHASSIS_CYBERGEAR_DIRECTION_SIGN   (-1.0f)
#define CHASSIS_CYBERGEAR_MIN_ANGLE_DEG    (-30.0f)
#define CHASSIS_CYBERGEAR_MAX_ANGLE_DEG    (30.0f)
