...
// 说明书 4.1.11 常用参数地址（通信类型18写入，通信类型17读取）
#define CYBERGEAR_PARAM_RUN_MODE   (0x7005U)
#define CYBERGEAR_PARAM_IQ_REF     (0x7006U)
#define CYBERGEAR_PARAM_SPD_REF    (0x700AU)
#define CYBERGEAR_PARAM_LOC_REF    (0x7016U)
#define CYBERGEAR_PARAM_LIMIT_SPD  (0x7017U)
#define CYBERGEAR_PARAM_LIMIT_CUR  (0x7018U)
