...
motor_pid_parameter motor_6020_pid_g[1];/*电机pid参数*/
motor_pid_parameter motor_rc_foc_pid_g[1];
...
//	Pid_increment_struct_init(&motor_6020_pid_g[0].loc,  1.1, 	0.015,	0.083,   18000,   -18000);
//    	//Pid_increment_struct_init(&motor_6020_pid_g[0].loc,  0, 	0,	0,   18000,   -18000);
//	Pid_increment_struct_init(&motor_6020_pid_g[0].spd,  70.0, 	3.5,	  0,   28000,  -28000);
//		Pid_increment_struct_init(&motor_6020_pid_g[0].loc,  0.9, 	0,	0.24,   18000,   -18000);
//    	//Pid_increment_struct_init(&motor_6020_pid_g[0].loc,  0, 	0,	0,   18000,   -18000);
//	Pid_increment_struct_init(&motor_6020_pid_g[0].spd,  70, 	3.5,	  0.4,   28000,  -28000);
		Pid_increment_struct_init(&motor_6020_pid_g[0].loc, 0.9, 	0,	0,   18000,   -18000);
    	//Pid_increment_struct_init(&motor_6020_pid_g[0].loc,  0, 	0,	0,   18000,   -18000);
	Pid_increment_struct_init(&motor_6020_pid_g[0].spd,  70, 	3.5,	  0,   25000,  -25000);
