...
/* USER CODE BEGIN 0 */
uint8_t Rx_data3[500] = {0};//����3�������ݻ�����
uint8_t Rx_data1[500] = {0};//����4�������ݻ�����
...
{
    uint8_t ch;  //����һ���޷���8λ���ͱ���ch �����ַ�C��ֵ����
    ch = c;
    HAL_UART_Transmit(&huart3,&ch,1,1000);
    return c;
}

//�Զ���printf������ͨ��dmaʵ�ִ��ڴ�ӡ���
#define BUFSIZE 500
...
//////			BEEP();
//////			//HAL_TIM_Base_Start_IT (&htim3);//���жϿ�����ʱ��3
//////		}
...
//////			BEEP();
//////		}
//////		HAL_UARTEx_ReceiveToIdle_DMA(&huart3, Rx_data3, 500);//��������dma����
